...
# !pip install opencv-python-headless==4.5.1.48         Error
# !pip install lvis
...
def class_text_to_int(row_label):
    if row_label == "Cancro":  # 'ship':
        return 1
    elif row_label == "Mancha negra":
        return 2
    elif row_label == "OK":
        return 3
    elif row_label == "Sarna":
        return 4
    elif row_label == "Melanosis":
        return 5
    else:
        None
...
csv_input = "labelStudio_test.csv"
